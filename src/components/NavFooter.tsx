...
export const Nav: React.FC = () => {
  ...
  return (
    <nav style={{
      ...
      background: scrolled ? 'rgba(237,230,220,0.85)' : 'transparent',
...
export const Footer: React.FC = () => (
  <footer style={{ padding: '48px 28px', maxWidth: 1100, margin: '0 auto', borderTop: '1px solid rgba(200,188,172,0.3)' }}>
